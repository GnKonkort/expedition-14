...
public sealed partial class HumanoidAppearanceComponent : Component
{
    ...
    /// </summary>
    [DataField]
    public HashSet<HumanoidVisualLayers> HideLayersOnEquip = [HumanoidVisualLayers.Hair, HumanoidVisualLayers.ErpChest, HumanoidVisualLayers.ErpGroin]; // Arcane: ErpChest/ErpGroin
